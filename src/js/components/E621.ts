...
export class E621 {
     ...
     */
    public async createRequest(path: string, query: string, method: "GET" | "POST" | "PUT" | "PATCH" | "DELETE", requestBody: string, endpoint: string, node: string, delay: number): Promise<any> {
        ...
        query = query
            ...
            + "&api_key=" + Util.readCookie("api_key");
